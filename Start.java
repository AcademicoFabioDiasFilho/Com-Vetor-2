...
final class Pessoa {
    ...
    private final CategoriaDeSexo sexo;

    public Pessoa(final double altura, final CategoriaDeSexo sexo) {
        this.altura = altura;
        this.sexo = sexo;
    }
    ...
    public CategoriaDeSexo getSexo() {
        return this.sexo;
    }
}
    ...
    private static void comecar() {
        ...
        for (int i = 0; i < 10; ) {
            ...
            */
            ...
            pessoas.add(new Pessoa(altura, (CategoriaDeSexo) sexoObj));
            i++;
        }
